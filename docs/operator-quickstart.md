# Operator Quickstart — Community Building Cleaning Operations

Shortest path from clone to a verified local dry-run for **ISIC 8121** (`cloud-itonami-isic-8121`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-8121.git
cd cloud-itonami-isic-8121
```
...
- Blueprint governor key: `building-cleaning-governor`
- Likely source path: `src/**/building-cleaning-governor.cljc`
